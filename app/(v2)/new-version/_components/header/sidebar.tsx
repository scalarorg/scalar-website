  ...
  return (
    <Fragment>
      <HamburgerIcon
        ...
        className={cn("text-white aspect-square max-sm:w-6 cursor-pointer")}
      />
      <div
        className={cn(
