...
import CloseMobile from '@/public/icon/close-mobile.svg?url';
import LogoSmall from '@/public/icon/logo-small.svg?url';
import LogoWhite from '@/public/icon/logo-white.svg?url';
import Logo from '@/public/icon/logo.svg?url';
import SidebarClose from '@/public/icon/sidebar-close.svg?url';
