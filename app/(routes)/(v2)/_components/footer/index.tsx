  ...
  return (
    <div>
      <div className={footerVariants({ className })} {...props}>
        ...
        <div
          className={cn(
            'w-full flex gap-1 text-black text-xs md:text-[13px] font-medium 2xl:font-bold xl:text-[18px] 2xl:text-[22px] xl:leading-[33px]',
          )}
        >
          Copyright ©<span className="text-black">Scalar</span>| Designed by
          Scalar
        </div>
      </div>
    </div>
